...
class BeaconRegionViewController: UIViewController, UITextFieldDelegate {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        NotificationCenter.default.addObserver(self, selector:#selector(BeaconRegionViewController.didEnterBackground), name: UIApplication.didEnterBackgroundNotification, object:nil)
    }
