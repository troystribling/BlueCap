...
//    }
//    
//    convenience public init(capacity:Int?=nil, timeoutRetries:Int=-1, disconnectRetries:Int=-1, connectionTimeout:Double=10.0, characteristicTimeout:Double=10.0) {
//        self.timeoutRetries = timeoutRetries
//        self.disconnectRetries  = disconnectRetries
//        self.connectionTimeout = connectionTimeout
//        self.characteristicTimeout = characteristicTimeout
