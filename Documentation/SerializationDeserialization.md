...
Serialization and deserialization of device messages to and from `NSData` objects requires Protocol implementations that structurally define the. Example implantations of each protocol can be found in the [TiSensorTag GATT Profile](BlueCapKit/Service%20Profile%20Definitions/TISensorTagServiceProfiles.swift). 
